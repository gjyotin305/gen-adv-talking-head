...
if __name__ == "__main__":
    ...
    # nohup python download_voxCeleb.py --dataset vox1 --output_path ./VoxCeleb1_train --metadata_path ./vox1_txt_train --delete_mp4 >> log_1_0.txt &
    ...
    depth_encoder = depth.ResnetEncoder(50, pretrained=False)
    depth_decoder = depth.DepthDecoder(num_ch_enc=depth_encoder.num_ch_enc, scales=range(4))
    loaded_dict_enc = torch.load('depth/models/weights_19/encoder (1).pth')
    loaded_dict_dec = torch.load('depth/models/weights_19/depth (1).pth')
